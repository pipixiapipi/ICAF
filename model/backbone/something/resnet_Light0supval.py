...
class ResNet(nn.Module):
    ...
    def base_forward(self, x=None, guide=None, val=None):
        if guide:
            x0, x1 = x
            ...
            for ii in range(len(x0)):
                # print(ii)
                x_tmp_0 = self.relu(self.bn1(self.conv1(x0[ii])))
                x_fea_lst_0.append(x_tmp_0)
            ...
            for ii in range(len(x1)):
                # print(ii)
                x_tmp_1 = self.relu(self.bn1(self.conv1(x1[ii])))
                x_fea_lst_1.append(x_tmp_1)
