...
class ResNet(nn.Module):
    ...
    #             # print(ii)
    #             x_0_tmp = self.relu(self.bn1(self.conv1(x[ii])))
    #             x_fea_lst_val.append(x_0_tmp)
    #         x = torch.stack(x_fea_lst_val)
    #         x = torch.sum(x, dim=0)
    #
    #         x = [att_block(x_i, x) for att_block, x_i in zip(self.att_blocks, x_fea_lst_val)]
